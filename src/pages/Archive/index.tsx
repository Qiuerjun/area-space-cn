    ...
    <div className="min-h-screen p-8">
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-mono text-cyan-400">站点档案</h1>
        </div>
      ...
      <motion.section
        ...
        className="mb-8 bg-gradient-to-r from-[#0a0a1a] to-[#0d1525] border border-cyan-500/30 p-12 text-center"
      >
        <p className="text-4xl font-mono text-cyan-400 mb-4 tracking-wider">
          {siteInfo.motto}
        </p>
        <p className="text-gray-500 font-mono text-sm">
          —— Area-Space-CN 站点格言
      ...
      >
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-[#0a0a0f] border border-cyan-500/10 p-4">
            ...
            <p className="text-white font-mono text-sm">{siteInfo.fullName}</p>
          </div>
          <div className="bg-[#0a0a0f] border border-cyan-500/10 p-4">
            <p className="text-gray-500 font-mono text-xs mb-1">巡航区域</p>
            <p className="text-white font-mono text-sm">{siteInfo.location}</p>
          </div>
          <div className="bg-[#0a0a0f] border border-cyan-500/10 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {Object.values(techSpecs).map((tech, index) => (
            <motion.div
              ...
              className="bg-[#0a0a0f] border border-cyan-500/10 p-4 hover:border-cyan-500/30 transition-colors"
            >
          ...
          {departments.map((dept, index) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-center gap-3 bg-[#0a0a0f] border border-cyan-500/10 p-4 transition-all cursor-default"
              >
